...
pub trait FungibleTokenCore {
    ...
    fn ft_transfer(&mut self, sender_id: Option<AccountId>, receiver_id: AccountId, amount: U128, memo: Option<String>);
...
impl FungibleTokenCore for Contract {
    ...
    fn ft_transfer(&mut self, sender_id: Option<AccountId>, receiver_id: AccountId, amount: U128, memo: Option<String>) {
        ...
        let sender_id = sender_id.unwrap_or(env::predecessor_account_id());
